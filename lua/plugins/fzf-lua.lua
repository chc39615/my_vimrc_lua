---@class FzfLuaOpts: myutil.pick.Opts
---@field cmd string?
...
if not Myutil.pick.register(picker) then
    return {}
end
    ...
    { "junegunn/fzf", build = "./install --bin" },
    {
        ...
        init = function()
            ...
            vim.api.nvim_create_autocmd("BufEnter", {
                group = vim.api.nvim_create_augroup("fzf-lua_start_directory", { clear = true }),
                desc = "Start fzf-lua with directory",
                once = true,
                callback = function()
        ...
        keys = {
            ...
            { "<leader>/",       Myutil.pick("live_grep"),                                   desc = "Grep (Root Dir)" },
            { "<leader>:",       "<cmd>FzfLua command_history<cr>",                          desc = "Command History" },
            { "<leader><space>", Myutil.pick("auto"),                                        desc = "Find Files (Root Dir)" },
            -- find
            { "<leader>fb",      "<cmd>FzfLua buffers sort_mru=true sort_lastused=true<cr>", desc = "Buffers" },
            { "<leader>fc",      Myutil.pick.config_files(),                                 desc = "Find Config File" },
            { "<leader>ff",      Myutil.pick("auto"),                                        desc = "Find Files (Root Dir)" },
            { "<leader>fF",      Myutil.pick("auto", { root = false }),                      desc = "Find Files (cwd)" },
            { "<leader>fg",      "<cmd>FzfLua git_files<cr>",                                desc = "Find Files (git-files)" },
            { "<leader>fr",      "<cmd>FzfLua oldfiles<cr>",                                 desc = "Recent" },
            { "<leader>fR",      Myutil.pick("oldfiles", { cwd = vim.uv.cwd() }),            desc = "Recent (cwd)" },
            -- git
            ...
            { "<leader>sg",      Myutil.pick("live_grep"),                                   desc = "Grep (Root Dir)" },
            { "<leader>sG",      Myutil.pick("live_grep", { root = false }),                 desc = "Grep (cwd)" },
            ...
            { "<leader>sw",      Myutil.pick("grep_cword"),                                  desc = "Word (Root Dir)" },
            { "<leader>sW",      Myutil.pick("grep_cword", { root = false }),                desc = "Word (cwd)" },
            { "<leader>sw",      Myutil.pick("grep_visual"),                                 mode = "v",                       desc = "Selection (Root Dir)" },
            { "<leader>sW",      Myutil.pick("grep_visual", { root = false }),               mode = "v",                       desc = "Selection (cwd)" },
            { "<leader>uC",      Myutil.pick("colorschemes"),                                desc = "Colorscheme with Preview" },
            {
                "<leader>ss",
                function()
